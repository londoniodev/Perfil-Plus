        ...
        const fetchData = async () => {
            try {
                const requests: Promise<Response>[] = [
                    fetch(`${API_BASE}/blog/categories`, { headers: { 'x-tenant-id': tenantId }, signal: controller.signal }),
                    fetch(`${API_BASE}/blog/tags`, { headers: { 'x-tenant-id': tenantId }, signal: controller.signal }),
                ];

                if (mode === "edit" && postId) {
                    requests.push(
                        fetch(`${API_BASE}/admin/blog/posts/${postId}`, { headers: { 'x-tenant-id': tenantId }, credentials: "include", signal: controller.signal })
                    );
                }
