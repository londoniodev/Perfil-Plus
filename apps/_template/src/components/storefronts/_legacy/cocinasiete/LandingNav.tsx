            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    <div className="flex-shrink-0 flex items-center gap-2">
                        <span className="text-2xl font-black text-cs-secondary tracking-tight font-display drop-shadow-sm hover:scale-105 transition-transform cursor-pointer">
                            Cocinasiete
                        </span>
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <Link href="#planes" className="text-sm font-bold text-cs-secondary hover:text-cs-primary transition-colors">Planes</Link>
                        <Link href="#testimonios" className="text-sm font-bold text-cs-secondary hover:text-cs-primary transition-colors">Testimonios</Link>
                        <Link href="#nosotros" className="text-sm font-bold text-cs-secondary hover:text-cs-primary transition-colors">Nosotros</Link>
