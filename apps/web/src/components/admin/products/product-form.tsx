...
import { z } from "zod"
import { Button, Input, Textarea, Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from "@mauromera/ui"
...
const productSchema = z.object({
    ...
    variants: z.array(z.object({
        id: z.string().optional(), // Para manejo interno de field array si es necesario, aunque RHF usa 'id' propio
        name: z.string().optional(),
        sku: z.string().optional(), // El backend lo genera si falta, pero podemos validarlo aquí también
    ...
    if (data.productType === "PHYSICAL") {
        if (!data.variants || data.variants.length === 0) {
            ...
            data.variants.forEach((variant, index) => {
                // Validaciones visuales extra si se desean
