...
export class EvaluationService {
  ...
  async updateEvaluation(
    ...
    const evaluation = await this.prisma.secure.evaluation.findFirst({
  ...
  async updateQuestion(
    ...
    const question = await this.prisma.secure.question.findFirst({
