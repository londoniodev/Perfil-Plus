...
export default function EditarLeccionPage() {
    ...
    const fetchLesson = async () => {
        try {
            ...
            router.push(`/academia/cursos/temas/${params.id}/cursos/${params.courseId}`);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8">
            <Link href={`/academia/cursos/temas/${params.id}/cursos/${params.courseId}`} className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <IconBack size={16} />
                Volver al curso
            </Link>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="flex justify-end gap-3 pt-6 border-t">
                            <Button variant="outline" asChild>
                                <Link href={`/academia/cursos/temas/${params.id}/cursos/${params.courseId}`}>
                                    Cancelar
                                </Link>
                            </Button>
