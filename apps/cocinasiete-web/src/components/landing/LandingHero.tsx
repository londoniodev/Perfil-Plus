...
export function LandingHero() {
    return (
        <header className="relative pt-24 pb-12 overflow-hidden">
            ...
            {/* Decorative blobs */}
            <div className="absolute top-20 right-0 -mr-20 w-64 h-64 bg-orange-100  rounded-full blur-3xl -z-10 opacity-60" />
            <div className="absolute bottom-0 left-0 -ml-20 w-72 h-72 bg-emerald-100  rounded-full blur-3xl -z-10 opacity-60" />
        </header>
    );
}
