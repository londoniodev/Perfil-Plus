...
describe('EmployeesService', () => {
    ...
    describe('create', () => {
        ...
        it('debe convertir email a lowercase', async () => {
            mockClient.user.findUnique.mockResolvedValue(null);
            mockClient.user.create.mockResolvedValue({
                id: 'emp-2', email: 'test@test.com', name: 'Test',
                role: 'KITCHEN', avatar: null, createdAt: new Date(),
            });
        ...
        it('debe crear empleado con rol CASHIER', async () => {
            mockClient.user.findUnique.mockResolvedValue(null);
            mockClient.user.create.mockResolvedValue({
                id: 'emp-3', email: 'caja@test.com', name: 'Cajero',
    ...
    describe('findAll', () => {
        it('debe retornar solo usuarios con roles de staff', async () => {
            const staffUsers = [
                { id: '1', name: 'Mesero', email: 'a@b.com', role: 'WAITER', avatar: null, createdAt: new Date(), updatedAt: new Date() },
                { id: '2', name: 'Cocina', email: 'c@d.com', role: 'KITCHEN', avatar: null, createdAt: new Date(), updatedAt: new Date() },
            ];
    ...
    describe('findOne', () => {
        it('debe retornar un empleado por ID', async () => {
            mockClient.user.findUnique.mockResolvedValue({
                id: 'emp-1', email: 'test@t.com', name: 'Test',
        ...
        it('debe lanzar NotFoundException si el usuario no es staff', async () => {
            mockClient.user.findUnique.mockResolvedValue({
                id: 'user-1', email: 'u@u.com', name: 'User', role: 'USER',
    ...
    describe('update', () => {
        ...
        it('debe actualizar el nombre del empleado', async () => {
            mockClient.user.update.mockResolvedValue({
                id: 'emp-1', email: 'test@t.com', name: 'Nuevo Nombre',
