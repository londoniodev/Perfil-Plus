...
export const NAVIGATION_CONFIG: {
    ...
    admin: [
        ...
        { name: "Gestionar Formación", href: "/academia/cursos", icon: IconEdit, feature: 'lms' },
        { name: "Gestionar Blog", href: "/blog/publicaciones", icon: IconDocument, feature: 'blog' },
        { name: "Gestión de Productos", href: "/tienda/productos", icon: IconGrid, feature: 'shop' },
        { name: "Usuarios", href: "/usuarios", icon: IconUsers }, // Core admin feature
    ]
};
