...
async function main() {
    console.log("Iniciando Seed de Órdenes Reales para Dashboard...");

    const tenant = await prisma.tenant.findFirst();
    if (!tenant) {
        throw new Error("No hay Tenant en la BD.");
    }
    ...
    console.log("✅ Seed completado con 150 órdenes históricas para las gráficas.");
}
