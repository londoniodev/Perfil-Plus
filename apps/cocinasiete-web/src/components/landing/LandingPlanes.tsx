...
export function LandingPlanes() {
    return (
        <section className="py-12 bg-cs-surface-light ">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white  rounded-2xl p-6 shadow-xl shadow-gray-200/50  border border-gray-100  relative overflow-hidden group">
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-3 bg-orange-100  rounded-xl text-cs-secondary">
                    ...
                    <div className="bg-white  rounded-2xl p-6 shadow-xl shadow-gray-200/50  border border-gray-100 ">
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-3 bg-emerald-100  rounded-xl text-cs-primary">
                        ...
                        <Link href="/tienda" className="block text-center w-full py-3 rounded-xl border-2 border-gray-200  text-gray-600  font-bold hover:border-cs-primary hover:text-cs-primary transition-colors">
                            Ver Menú Hogar
                        </Link>
                    </div>
                </div>
