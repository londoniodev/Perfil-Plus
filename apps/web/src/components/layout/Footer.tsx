            ...
            <div className="container">
                ...
                <div className="hidden lg:flex flex-col items-center gap-8 mb-12">
                    ...
                    <nav className="flex items-center gap-8">
                        ...
                        <Link href="https://wa.me/573183771838" target="_blank" rel="noopener noreferrer" className="text-foreground/60 hover:text-foreground transition-colors text-sm">Contacto</Link>
