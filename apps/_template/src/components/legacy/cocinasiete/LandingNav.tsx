...
export function LandingNav() {
    return (
        <nav className="fixed w-full z-50 bg-white/70 backdrop-blur-xl shadow-sm border-b border-white/20 transition-all duration-300">
            <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    <div className="flex-shrink-0 flex items-center gap-2">
                        <span className="text-2xl font-black text-cs-primary tracking-tight font-display drop-shadow-sm">
                            Cocinasiete
                        </span>
                    </div>
