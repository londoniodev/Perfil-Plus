    ...
    return (
        <div className="min-h-screen">
            <PageHeader
                ...
                description="Explora procesos de formación diseñados para desarrollar líderes, mejorar equipos y potenciar tu desarrollo personal."
            />
            ...
            <section className="py-24 bg-primary/[0.02] border-y border-primary/5 text-center">
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="max-w-[600px] mx-auto mt-4 mb-10 text-body text-muted-foreground">
                        Únete a quienes ya han transformado su vida con nuestros programas de formación.
                    </p>
