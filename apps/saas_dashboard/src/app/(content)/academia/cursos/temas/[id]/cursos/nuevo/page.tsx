...
export default function NuevoCursoPage({ params }: NuevoCursoPageProps) {
    ...
    return (
        <div className="p-6 md:p-8 max-w-4xl mx-auto space-y-8">
            <Link href={`/academia/cursos/temas/${themeId}`} className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                <IconBack size={16} />
                Volver al Tema
            </Link>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-6 border-t">
                            <Button variant="outline" asChild>
                                <Link href={`/academia/cursos/temas/${themeId}`}>Cancelar</Link>
                            </Button>
